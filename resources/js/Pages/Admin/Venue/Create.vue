<template>
  <AppAdmin>
    <h1 class="text-2xl font-semibold">Create Venue</h1>
    ...
    <form @submit.prevent="submit">
      ...
      <div class="mb-4">
        ...
        <textarea v-model="form.address" class="mt-2 border-neutral-100 w-full rounded-lg" rows="4"
      ...
      <div class="mb-4">
        ...
        <textarea v-model="form.description" class="mt-2 border-neutral-100 w-full rounded-lg" rows="4"
          placeholder="Address"></textarea>
      ...
      <div class="mb-4">
        ...
        <input type="number" v-model="form.price" class="mt-2 border-neutral-100 w-full rounded-lg"
          placeholder="4000000" />
      ...
      <div class="mb-4">
        ...
        <input type="number" v-model="form.max_capacity" class="mt-2 border-neutral-100 w-full rounded-lg"
      ...
      <div class="mb-4">
        ...
        <input type="file" id="image" class="mt-2 border-neutral-100 w-full" placeholder="Max Capacity"
          @input="form.image = $event.target.files[0]" @change="preview" />
